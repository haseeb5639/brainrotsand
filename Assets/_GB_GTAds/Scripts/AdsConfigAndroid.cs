...
[CreateAssetMenu(fileName = "AdsConfigAndroid", menuName = "Custom/Ads Configuration (Android)")]
public class AdsConfigAndroid : ScriptableObject
{
    ...
    [ReadOnly]
    public string LowAppOpenID = "default";
    [ReadOnly]
    public string LowInterstitialID = "default";
    [ReadOnly]
    ...
    [PropertySpace(15)]
    [Title("KEYSTORE", null, TitleAlignments.Centered)]
    [ReadOnly]
    public string KeystoreName = "default";
    [ReadOnly]
