...
public class AndroidRateUsPopUp : MonoBehaviour
{
    ...
    public static AndroidRateUsPopUp Create(string title, string message, string rate, string declined)
    {
    ...
    public void init()
    {
        AndroidNative.showRateUsPopUP(title, message, rate, declined);
    }
