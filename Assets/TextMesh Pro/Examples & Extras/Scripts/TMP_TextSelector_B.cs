    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void LateUpdate()
        {
            if (isHoveringObject)
            {
                ...
                int charIndex = TMP_TextUtilities.FindIntersectingCharacter(m_TextMeshPro, ControlFreak2.CF2Input.mousePosition, m_Camera, true);
                ...
                if (charIndex != -1 && charIndex != m_lastIndex && (ControlFreak2.CF2Input.GetKey(KeyCode.LeftShift) || ControlFreak2.CF2Input.GetKey(KeyCode.RightShift)))
                {
                ...
                int wordIndex = TMP_TextUtilities.FindIntersectingWord(m_TextMeshPro, ControlFreak2.CF2Input.mousePosition, m_Camera);
                ...
                if (wordIndex != -1 && wordIndex != m_selectedWord && !(ControlFreak2.CF2Input.GetKey(KeyCode.LeftShift) || ControlFreak2.CF2Input.GetKey(KeyCode.RightShift)))
                {
                ...
                int linkIndex = TMP_TextUtilities.FindIntersectingLink(m_TextMeshPro, ControlFreak2.CF2Input.mousePosition, m_Camera);
                ...
                if (linkIndex != -1 && linkIndex != m_selectedLink)
                {
                    ...
                    RectTransformUtility.ScreenPointToWorldPointInRectangle(m_TextMeshPro.rectTransform, ControlFreak2.CF2Input.mousePosition, m_Camera, out worldPointInRectangle);
